...
print("1 is for dataset_TSMC2014_TKY.checkin.")
print("2 is for dataset_TSMC2014_NYC.checkin.")
input_num = input()
if input_num == '1':
    file_name = 'dataset_TSMC2014_TKY.checkin'
elif input_num == '2':
    file_name = 'dataset_TSMC2014_NYC.checkin'
else:
...
while (pnt != "" 
    ...
    if (int)(line_array[-5]) > spot_cnt:
        lati_list.append(line_array[-7])
        logi_list.append(line_array[-6])
        freq_list.append(1)
        spot_cnt += 1
    else:
        freq_list[(int)(line_array[-5])] += 1
